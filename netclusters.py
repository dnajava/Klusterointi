...
class NetClusters(Cluster):
    ...
    def add_kit(self, kit_p:Kit=None):
        ...
        self.nclusters.append( NetCluster(kit_p.gd0) )
        self.nclusters.append( NetCluster(kit_p.gd1) )
        self.nclusters.append( NetCluster(kit_p.gd2) )
        self.nclusters.append( NetCluster(kit_p.gd3) )
